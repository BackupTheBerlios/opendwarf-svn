...
syslogprefix="gloin_loadmodules: "
syslogident = "gloin_loadmodules"
...
def main():
	...
	try:
		...
		ldapWantedDnAttributes=["gotoModules"]
		...
		modules = retrievedAttriubutes["gotoModules"] 

		log_begin_msg("loading modules "+syslogident, False)
		for mod in modules:
			cmdIn, cmdOut, cmdErr = os.popen3('/sbin/modprobe '+mod)
			log_star()


		cmdIn, cmdOut, cmdErr = os.popen3('/sbin/modprobe usbkbd')
		log_star()
		cmdIn, cmdOut, cmdErr = os.popen3('/sbin/modprobe usbmouse')
		log_star()
